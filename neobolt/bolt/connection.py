...
from neobolt.bolt.cert import KNOWN_HOSTS
from neobolt.bolt.response import InitResponse, ResetResponse, Response
from neobolt.compat.ssl import SSL_AVAILABLE, HAS_SNI, SSLError
from neobolt.exceptions import ClientError, ProtocolError, SecurityError, ServiceUnavailable
...
from neobolt.config import default_config, INFINITE, TRUST_ON_FIRST_USE
    ...
    if ssl_context and SSL_AVAILABLE:
        ...
        try:
            ...
            if trust == TRUST_ON_FIRST_USE:
                from neobolt.bolt.cert import PersonalCertificateStore
